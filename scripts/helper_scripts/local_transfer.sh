...
# dfx canister call LP_ledger_canister icrc1_balance_of "(record {owner=principal\"um2uc-3w7jg-5lycg-pmjio-is7ms-jjzwo-kvwfa-xdeus-ur2tx-4sbzd-cae\"; subaccount=null})"

dfx canister call ckbtc_ledger icrc1_transfer ' (record {to=record {owner = principal "by6od-j4aaa-aaaaa-qaadq-cai"; subaccount=null}; fee=null; memo=null; from_subaccount=null; created_at_time=null; amount=50000000})'